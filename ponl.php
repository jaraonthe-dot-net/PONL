...
function scan4Scripts($S_dir) {
	...
	// TODO: what with several scripts evaluating to the same command name? Which will get precedence? Are all callable, and: how?
...
function runScript($S_file, $argv, $argc, $A_ponlCommands, $A_ponlCommandsBuiltIn, $A_ponlCommandsDeployed, $A_ponlCommandsScripts) {
